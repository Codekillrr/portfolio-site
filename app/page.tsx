        ...
        <div className="w-[55%] max-md:w-full pointer-events-auto h-full z-[3] ml-auto mt-[11em] relative max-md:pl-[8em] max-sm:pl-[5em] max-sm:px-[3em] px-[7em] max-[441px]:px-[2em]">
          ...
          <div className="mt-[4em] p-4 rounded-lg bg-slate-700/[0.2] transition-all ease-in-out duration-200 hover:bg-slate-800/[0.3] backdrop-blur-3xl">
            ...
            <div className="my-5 flex flex-col gap-1">
              ...
              <h3 className="max-[441px]:text-xl text-2xl font-sans font-bold text-[#5ba4d8]" >Software Engineering Fellow</h3>
              <h4 className="max-[441px]:text-lg text-xl font-sans font-bold text-[#5ba4d8]">Headstarter AI</h4>
              ...
              <h3 className="max-[441px]:text-xl text-2xl font-sans font-bold text-[#5ba4d8] mt-4">Junior Analyst</h3>
              <h4 className="max-[441px]:text-lg text-xl font-sans font-bold text-[#5ba4d8]">Kaizen Tech Solutions</h4>
              <p className="max-[441px]:text-sm text-lg font-sans text-[#5ba4d8]">
                <em>
          ...
          <div className="my-[4em] p-4 rounded-lg bg-slate-700/[0.2] transition-all ease-in-out duration-200 hover:bg-slate-800/[0.3] backdrop-blur-3xl">
            ...
            <div className="flex flex-col w-full h-full">
              <div className="flex max-sm:flex-col flex-row"> 
                <button className=" flex flex-col p-4 transition-all ease-in-out duration-200 border-slate-900 max-sm:w-full w-[50%] hover:border hover:p-[0.94rem] rounded-lg">
              ...
              <div className="flex max-sm:flex-col flex-row"> 
                ...
                <button className="flex flex-col p-4 transition-all ease-in-out duration-500 border-slate-900 max-sm:w-full w-[50%] hover:border hover:p-[0.94rem] rounded-lg">
                  <div className="bg-black w-full h-[160px] rounded-md"></div>
              ...
              <button className="m-8 mx-auto max-sm:w-[80%] w-[40%] text-lg h-10 hover:border border-slate-900 rounded-lg transition-all ease-in-out bg-slate-700/50 hover:bg-slate-700/70 text-slate-300 font-bold font-sans">View Full Portfolio</button>
            </div>
          ...
          <div className="my-[4em] p-4 rounded-lg bg-slate-700/[0.2] transition-all ease-in-out duration-200 hover:bg-slate-800/[0.3] backdrop-blur-3xl">
            ...
            <button onClick={()=>SetSent(!sent)} className="my-5 max-sm:w-[75%] max-sm:mx-12 w-[30%] h-[3rem] hover:border-2 hover:bg-slate-700/20 border-slate-900 rounded-lg transition-all ease-in-out bg-slate-800/30 text-slate-300 font-bold font-sans">Send</button>
